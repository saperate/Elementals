...
import dev.saperate.elementals.entities.common.SkyBisonEntityRenderer;
...
public class ElementalsClient implements ClientModInitializer {
    ...
    public static final EntityModelLayer MODEL_METAL_LANCE_LAYER = (new EntityModelLayer(Identifier.of(MODID, "metal_lance"),"bb_main"));
    ...
    public void registerGlobalReceiver(ElementalPacket t){
        ClientPlayNetworking.registerGlobalReceiver(t.getId(), (payload, context) -> {
