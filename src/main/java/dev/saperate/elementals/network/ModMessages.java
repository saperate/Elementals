...
public class ModMessages {
    ...
    public static final Identifier TOGGLE_UPGRADE_PACKET_ID = new Identifier(MODID,"toggle_upgrade");
    ...
    public static void registerC2SPackets(){
        ...
        ServerPlayNetworking.registerGlobalReceiver(TOGGLE_UPGRADE_PACKET_ID, ToggleUpgradeC2SPacket::receive);
