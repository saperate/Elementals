...
public class SkyBisonModel extends DefaultedEntityGeoModel<SkyBisonEntity> {
    private final ResourceLocation model = ResourceLocation.fromNamespaceAndPath(Constants.MODID, "geo/entity/sky_bison.geo.json");
    private final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(Constants.MODID, "textures/entity/sky_bison.png");
