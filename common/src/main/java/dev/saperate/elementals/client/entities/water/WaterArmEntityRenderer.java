...
public class WaterArmEntityRenderer extends EntityRenderer<WaterArmEntity> {
    ...
    public WaterArmEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(WaterArmEntity entity, float yaw, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light) {
    ...
    @Override
    public ResourceLocation getTextureLocation(WaterArmEntity entity) {
        return texture;
    }
}
