...
public class SkyBisonSaddleModel extends DefaultedEntityGeoModel<SkyBisonEntity> {
    private final ResourceLocation model = ResourceLocation.fromNamespaceAndPath(Elementals.MODID, "geo/entity/sky_bison_saddle.geo.json");
    private final ResourceLocation texture = ResourceLocation.fromNamespaceAndPath(Elementals.MODID, "textures/entity/sky_bison_saddle.png");
